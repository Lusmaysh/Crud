...
<body>
    ...
    <h2 class="title" style="text-align:center; text-decoration: underline;">Data Buku</h2>    

    <div class="TombolTambahan">
        <a href="AddBuku.php" class="href">Tambah Data</a>
        <a href="cetak.php?id=buku" class="href">Cetak Data</a>
    </div>
            ...
            <tbody>
                <?php 
                    ...
                    while($DataInventory = mysqli_fetch_array($query) ) 
                    {
                        ...
                        echo "<td>";
                        echo "<a href='EditBuku.php?id=".$DataInventory['kode']."' >Edit</a> | ";
                        echo "<a href='hapus.php?id=".$DataInventory['kode']."&table=buku'>Hapus</a>";
                        echo "</td>";
                        echo "</tr>";
                        $x++;
                    }
