...
if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = mysqli_query($db, "SELECT * FROM buku WHERE kode='$id'");
    $data = mysqli_fetch_assoc($query);    
}

if(isset($_POST["submit"])) {
    if( simpan($_POST, 'buku') > 0 ) {
        echo "<script>
        ...
        echo "<script>
            ...
            document.location.href = 'EditBuku.php';
        </script>";
    }
}
...
<body>
    ...
    <div class="container">
        <h2 class="title" style="text-align:center; text-decoration: underline;">Edit Data Buku</h2>    
